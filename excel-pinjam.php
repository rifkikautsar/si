...
$query = mysqli_query($db,"SELECT p.id_pinjam, p.tgl_pinjam, rp.id_barang,rp.jml_barang, b.nm_barang, k.nm_kat, a.nm_anggota, pt.nm_petugas, s.nm_satuan
...
JOIN kategori_barang k USING(id_kat) JOIN petugas pt USING(id_petugas) JOIN satuan s USING(id_satuan)
