...
<body>
    ...
    <div class="mx-4 mb-2">
        ...
        <input class="form-control form-control-sm" name="nama_petugas" style="width: 1000px;" type="text">
    </div>
    <div class="mx-4 mb-2">
        <label for="hak_akses class=" form-label">Hak Akses</label>
        <input class="form-control form-control-sm" name="hak_akses" style="width: 1000px;" type="text">
    </div>
    <div class="mx-4 mb-2">
        <label for="username=" form-label">Username</label>
        <input class="form-control form-control-sm" name="username" style="width: 1000px;" type="text">
    </div>
    <div class="mx-4 mb-2">
        <label for="password class=" form-label">Password</label>
        <input class="form-control form-control-sm" name="password" style="width: 1000px;" type="password">
    </div>
    <div class="mx-4 mb-2">
