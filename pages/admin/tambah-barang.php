...
<body>
    ...
    <div class="d-flex flex-row bd-highlight mb-3">
        <div class="mx-4 mb-2">
            ...
            <input class="form-control form-control-sm" name="jumlah_barang" style="width: 475px;" type="text">
        </div>
        <div class="form-group mx-4 mb-2">
    ...
    <div class="d-flex flex-row bd-highlight mb-3">
        <div class="mx-4 mb-2">
            ...
            <input class="form-control form-control-sm" name="tanggal" style="width: 475px; height:31px;" type="date">
        </div>
        <div class="mx-4 mb-2">
            <label for="sumber_dana class=" form-label">Sumber Dana</label>
            <input class="form-control form-control-sm" name="sumber_dana" style="width: 475px;" type="text">
        </div>
    </div>
    <div class="d-flex justify-content-center flex-row bd-highlight mb-3">
        <button type="button" class="btn mx-3 mt-3" style="background-color:#366ad0; color:white;">Save</button>
        <button type="button" class="btn mx-3 mt-3" style="background-color:#366ad0; color:white;">Reset</button>
    </div>
    </div>
